# Skill: DevRel & Traction

**Purpose:** Assist with community building, demo preparation, and progress tracking via Arc CLI.
...
- Traction metrics: number of test users, USDC saved, transactions, rescue events.
